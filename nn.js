...
const bot = new aoijs.AoiClient({
    token: "MTA1MTc1NzU1ODM1ODA5Nzk2MQ.GeANWY.kMJyGjwSV0LSD7xOAtkpSdXAbCi31g9qmuM8uM",
    prefix: "-",
...
$description[1;💵 **Your Cash : [NPR $roundTenth[$getUserVar[cash;$findUser[$message;yes]];3]\](https://discord.gg/hgp)**]
...
$addField[1;**Created** <t:$round[$divide[$creationDate[$findUser[$message;yes];ms];1000]]:R> • **Joined** <t:$round[$divide[$memberJoinedDate[$findUser[$message;yes];$guildID;ms];1000]]:R>;\` \` 🏵 **Hangout Points : [$getUserVar[bounty;$findUser[$message;yes]] HPs\](https://discord.gg/hgp) **$replaceText[$replaceText[$checkContains[$day;friday;saturday];true;:small_orange_diamond: +10% Weekend];false;$replaceText[$replaceText[$hasRoles[$guildID;$findUser[$message;yes];1050690197668511794];true;:small_orange_diamond: +10% Booster];false;]]
\` \` 💵 **Cash : [NPR $roundTenth[$getUserVar[cash;$findUser[$message;yes]];3]\](https://discord.gg/hgp)**]
...
>>> 🏵 **Hangout Points : [$getUserVar[bounty;$findUser[$message;yes]] HPs\](https://discord.gg/hgp) **[$replaceText[$replaceText[$checkContains[$day;friday;saturday];true;:small_orange_diamond: +10% Weekend];false;$replaceText[$replaceText[$hasRoles[$guildID;$findUser[$message;yes];1050690197668511794];true;:small_orange_diamond: +10% Booster];false;No Boosts]]\]
💵 **Cash : [NPR $roundTenth[$getUserVar[cash;$findUser[$message;yes]];3]\](https://discord.gg/hgp)** [Rate : NPR 1/2K HPs\]]
...
bot.command({
    ...
    $footer[1;🔥 $getUserVar[attendance;$findUser[$message;true]] day(s) streak • ⭐ $getUserVar[chatXP;$findUser[$message;true]] chatXPs • 💮 $getUserVar[rep;$findUser[$message;true]] Reps]
    ...
    $let[img;$replaceText[%7B%22type%22%3A%22bar%22%2C%22data%22%3A%7B%22labels%22%3A%5B%22Sun%22%2C%22Mon%22%2C%22Tue%22%2C%22Wed%22%2C%22Thu%22%2C%22Fri%22%2C%22Sat%22%5D%2C%22datasets%22%3A%5B%7B%22label%22%3A%22$get[lable2]%22%2C%22backgroundColor%22%3A%22$get[color]50%22%2C%22borderColor%22%3A%22$get[color]%22%2C%22borderWidth%22%3A2%2C%22data%22%3A%5B$get[sun]%2C$get[mon]%2C$get[tue]%2C$get[wed]%2C$get[thu]%2C$get[fri]%2C$get[sat]%5D%2C%22datalabels%22%3A%7B%22align%22%3A%22center%22%2C%22anchor%22%3A%22center%22%7D%7D%5D%7D%2C%22options%22%3A%7B%22responsive%22%3Atrue%2C%22legend%22%3A%7B%22position%22%3A%22top%22%7D%2C%22title%22%3A%7B%22display%22%3Atrue%2C%22text%22%3A%22$get[lable]%22%7D%2C%22plugins%22%3A%7B%22roundedBars%22%3Atrue%2C%22datalabels%22%3A%7B%22color%22%3A%22%23000000%22%7D%7D%7D%7D;$day;Today%20✨]
    $let[img2;$replaceText[https://quickchart.io/chart?bkg=%23fffefe&c=%7B%22type%22%3A%22bar%22%2C%22data%22%3A%7B%22labels%22%3A%5B%22Sun%22%2C%22Mon%22%2C%22Tue%22%2C%22Wed%22%2C%22Thu%22%2C%22Fri%22%2C%22Sat%22%5D%2C%22datasets%22%3A%5B%7B%22label%22%3A%22$get[lable]%22%2C%22backgroundColor%22%3A%22$get[color]50%22%2C%22borderColor%22%3A%22$get[color]%22%2C%22borderWidth%22%3A2%2C%22data%22%3A%5B$get[sun]%2C$get[mon]%2C$get[tue]%2C$get[wed]%2C$get[thu]%2C$get[fri]%2C$get[sat]%5D%2C%22datalabels%22%3A%7B%22align%22%3A%22center%22%2C%22anchor%22%3A%22center%22%7D%7D%5D%7D%2C%22options%22%3A%7B%22responsive%22%3Atrue%2C%22legend%22%3A%7B%22position%22%3A%22top%22%7D%2C%22title%22%3A%7B%22display%22%3Atrue%2C%22text%22%3A%221%20Week%20Message%20Cunts%22%7D%2C%22plugins%22%3A%7B%22roundedBars%22%3Atrue%2C%22datalabels%22%3A%7B%22color%22%3A%22%23000000%22%7D%7D%7D%7D;$day;Today%20✨]
...
$if[$message[1]==streaks;
    ...
    $description[1;$userLeaderboard[$guildID;attendance;asc;> {top}. **{username} :  [{value}\](https://discord.gg/hgp)** day(s) 🔥;10;1]]
;
    $if[$message[1]==cash;
        $title[1;💵 Cash Leaderboards]
        $description[1;$userLeaderboard[$guildID;cash;asc;> {top}. **{username} :  NPR [{value}\](https://discord.gg/hgp)**;10;1]]
        $color[1;#fcb8fd]
    ;
        $if[$message[1]==chatxp;
            $title[1;⭐ ChatXPs Leaderboards]
            $description[1;$userLeaderboard[$guildID;chatXP;asc;> {top}. **{username} :  [{value}\](https://discord.gg/hgp)** XPs;10;1]]
            $color[1;#fcb8fd]
        ;
            $if[$message[1]==reps;
                $title[1;💮 Reps Leaderboards]
                $description[1;$userLeaderboard[$guildID;rep;asc;> {top}. **{username} :  [{value}\](https://discord.gg/hgp) Reps**;10;1]]
                $color[1;#fcb8fd]
            ]
        ]
    ]
...
$onlyIf[$checkContains[$message[1];reps;chatxp;cash;points;streaks]==true;❓ <@$authorID>**, also mention the leaderboards type.** Available Types : \` points, cash, chatxp, streaks, reps \`]
$onlyIf[$guildID!=;]
    `
}) //streak
...
$description[1;[[•.•ิ\] Status from Last report to current report.\](https://instagram.com/_rajat.cj/)
]


$addfield[1;👋 Total Visitors : $sum[$splitText[6];$splitText[7]];**╰**Regular : $splitText[6]ㅤㅤㅤㅤㅤ**╰**Irregular/New : $splitText[7];no]

$addField[1;🔥 Streak;$userLeaderboard[$guildID;attendance;asc;> {top}. **{username} :  [{value}\](https://instagram.com/_rajat.cj/)** day(s);3;1];yes]

$addField[1;💥 Experience;$userLeaderboard[$guildID;bounty;asc;> {top}. **{username} :  [{value}\](https://instagram.com/_rajat.cj/)** XPs;3;1];yes]
...
> ** **
> $getLeaderboardInfo[warncount;$authorID;user;top]. **$getLeaderboardInfo[warncount;$authorID;user;name] : [$getLeaderboardInfo[warncount;$authorID;user;value]\](https://instagram.com/_rajat.cj/)** strikes. (YOU)]
$color[1;#F81515]
$onlyIf[$guildID!=;]
  `
})
